  ...
  return (
    ...
    >
      <div className="container">
        <a href="#" className="nav-logo" title="Karan Kushwaha">
          <span className="nav-brand-script">Karan Kushwaha</span>
        </a>
        ...
        <div className="nav-right-group">
          ...
          <ul className="nav-links nav-links-desktop">
            ...
            <li>
              <a
                href="/Karan Kushwaha ( Resume ) .pdf"
                download="Karan Kushwaha ( Resume ) .pdf"
