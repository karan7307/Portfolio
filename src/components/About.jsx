...
const skillCategories = [
  {
    ...
    icon: Terminal,
    color: 'var(--accent-1)',
    skills: ['Python', 'C / C++ (DSA)', 'JavaScript', 'SQL', 'FastAPI', 'Flask', 'React', 'HTML5 & CSS3']
  },
  {
    category: 'AI & Machine Learning',
    icon: Brain,
    color: 'var(--accent-2)',
    skills: ['Azure Cognitive Services', 'Generative AI & LLMs', 'Nutanix AI Platform 6', 'Prompt Engineering', 'NLP']
  },
  {
    category: 'Cloud & Infrastructure',
    icon: Cloud,
    color: 'var(--accent-3)',
    skills: ['Microsoft Azure', 'Google Cloud Platform (GCP)', 'Nutanix HCI', 'Multicloud Automation', 'Terraform (IaC)', 'Docker']
  },
  {
    category: 'Databases & Developer Tools',
    icon: Database,
    color: 'var(--text-primary)',
    skills: ['Microsoft Fabric', 'PostgreSQL', 'MongoDB', 'MySQL', 'Data Pipelines', 'Azure Portal', 'GCP Console', 'Git & GitHub']
  }
];

const stats = [
  { number: '90+', label: 'ATS Resumes Crafted', icon: FileText, color: 'var(--accent-1)' },
  { number: '6+', label: 'Cloud & AI Certifications', icon: Award, color: 'var(--accent-2)' },
  { number: '80%', label: 'Client Satisfaction Score', icon: CheckCircle, color: 'var(--accent-3)' }
];
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(360px, 1fr))', gap: '2.5rem', alignItems: 'center', width: '100%' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
              ...
              <p style={{ color: 'var(--text-secondary)', fontSize: 'clamp(1.05rem, 1.3vw, 1.25rem)', lineHeight: '1.85' }}>
                Microsoft, Nutanix, and Google Cloud multi-certified Computer Science student specializing in Artificial Intelligence and Machine Learning. Experienced freelance technical resume specialist and web developer on Fiverr with proven success crafting 90+ ATS-optimized resumes and high-converting digital assets for engineering professionals. Developing deep technical expertise in cloud computing, multicloud automation, hyperconverged infrastructure, data engineering, and AI applications. Seeking to leverage strong technical skills, multiple industry certifications, and creative problem-solving abilities to contribute to innovative projects in AI/ML, cloud automation, or infrastructure engineering roles.
              </p>
            </div>
          ...
          <div style={{ width: '100%' }}>
            ...
            <div className="glass-panel" style={{ padding: '1.8rem 2.5rem', marginTop: '2.5rem', width: '100%' }}>
              <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', textAlign: 'center', lineHeight: '1.6' }}>
                <strong style={{ color: 'var(--text-primary)' }}>Soft Skills:</strong> Creative Problem Solving • Team Collaboration • Client Communication • Technical Documentation • Time Management • Agile Mindset
              </p>
            </div>
